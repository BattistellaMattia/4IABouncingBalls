...
3. Clicca sulle palline per eliminarle prima che il gioco finisca
...
```
4IABouncingBalls/
├── index.html      # Pagina principale – canvas di gioco
├── help.html       # Istruzioni e regole del gioco
├── end.html        # Schermata di fine partita (vittoria/sconfitta)
├── main.js         # Logica di gioco: animazione, collisioni, eventi
...
| Tecnologia | Utilizzo |
|---|---|
| HTML5 / Canvas API | Struttura e rendering grafico |
...
```bash
git clone https://github.com/BattistellaMattia/4IABouncingBalls.git
cd 4IABouncingBalls
# Apri index.html nel browser preferito
```
